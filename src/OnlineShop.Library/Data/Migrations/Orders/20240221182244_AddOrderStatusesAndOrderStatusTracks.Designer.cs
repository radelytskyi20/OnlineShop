...
namespace OnlineShop.Library.Data.Migrations.Orders
{
    ...
    [Migration("20240221182244_AddOrderStatusesAndOrderStatusTracks")]
    partial class AddOrderStatusesAndOrderStatusTracks
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineShop.Library.OrdersService.Models.OrderStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnlineShop.Library.OrdersService.Models.OrderStatusTrack", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OnlineShop.Library.OrdersService.Models.OrderStatusTrack", b =>
                {
                    b.HasOne("OnlineShop.Library.OrdersService.Models.Order", "Order")
                        .WithMany("OrderStatusTracks")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OnlineShop.Library.OrdersService.Models.OrderStatus", "OrderStatus")
                        .WithMany()
            ...
            modelBuilder.Entity("OnlineShop.Library.OrdersService.Models.Order", b =>
                {
                    ...
                    b.Navigation("OrderStatusTracks");
                });
